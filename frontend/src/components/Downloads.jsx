  ...
  const [pdfFiles, setPdfFiles] = useState([
    {
      ...
      file: new File([new Blob(['Dummy PDF content 1'])], 'student_handbook_2024.pdf', { type: 'application/pdf' }),
      size: '2.45 MB',
    ...
    },
    {
      id: '2',
      name: 'Admission Form',
      file: new File([new Blob(['Dummy PDF content 2'])], 'admission_form.pdf', { type: 'application/pdf' }),
      size: '1.78 MB',
      uploadDate: new Date('2024-01-20').toLocaleDateString(),
    },
    {
      id: '3',
      name: 'Academic Calendar',
      file: new File([new Blob(['Dummy PDF content 3'])], 'academic_calendar.pdf', { type: 'application/pdf' }),
      size: '3.21 MB',
      uploadDate: new Date('2024-01-25').toLocaleDateString(),
    },
    {
      id: '4',
      name: 'Library Guide',
      file: new File([new Blob(['Dummy PDF content 4'])], 'library_guide.pdf', { type: 'application/pdf' }),
      size: '0.89 MB',
      uploadDate: new Date('2024-02-01').toLocaleDateString(),
    },
  ]);
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6 relative overflow-x-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <header className="mb-8 flex flex-col sm:flex-row justify-between items-start gap-3">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Downloads</h1>
          </div>
          <button
            id="add-button"
        ...
        >
          <div className="h-full flex flex-col">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h2 className="text-xl font-semibold text-gray-800">Upload Downloadable File</h2>
              <button
        ...
        >
          <div className="h-full flex flex-col">
            {/* Panel Header */}
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h2 className="text-xl font-semibold text-gray-800">Edit Downloadable File</h2>
              <button
                onClick={cancelEdit}
                className="text-gray-400 hover:text-gray-600 transition-colors p-1"
              >
