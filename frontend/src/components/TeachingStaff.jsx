          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold mt-1">
                Teaching Staff <span className="font-bold text-gray-700">({staffMembers.length})</span>
              </h1>
                        ...
                        {newStaff.imagePreview ? (
                          <div className="relative aspect-square w-52 h-52 max-w-xs mx-auto rounded-xl overflow-hidden border-2 border-gray-200 shadow-lg">
                            ...
                            <button
                              ...
                              className="absolute top-2 right-2 pr-1 transition duration-200 "
                              title="Remove image"
                            >
                              <Trash2 className='w-6 h-6 text-white bg-red-600 rounded-2xl p-1' />
                            </button>
                          </div>
                        ) : (
                          <div className="aspect-square w-52 h-52 max-w-xs mx-auto rounded-xl overflow-hidden border-2 border-dashed border-gray-300 bg-gray-50 flex flex-col items-center justify-center p-6 hover:border-blue-500 hover:bg-blue-50 transition-all duration-300">
                            ...
                            <p className="text-gray-500 text-sm group-hover:text-blue-700 transition-colors text-center">Click to upload image</p>
                          </div>
                        )}
                    ...
                    <div className="pt-4">
                      {isEditing ? (
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <button
                            type="submit"
                            className="px-4 py-3 bg-blue-400/30 text-blue-950 rounded-lg font-medium  transition duration-200"
                          >
                            Save Changes
                          </button>
                        </div>
            ...
            {staffMembers.map((staff) => (
              ...
              >
                ...
                <div className="h-40 md:h-56 w-full overflow-hidden relative">
                  ...
                  >
                    <svg 
                      className={`w-7 h-7 p-1 rounded-2xl drop-shadow-lg transition-colors duration-200 ${
                        staff.isFeatured 
                ...
                <div className="p-4 flex-1 flex flex-col">
                  ...
                  <div className="mt-3 text-xs text-gray-700 space-y-1">
                    <p className="flex items-center">
                      ...
                      <span>{staff.education || 'Not specified'}</span>
                    </p>
                    <div className="flex items-center justify-between">
                      <p className="flex items-center">
                        <span className="mr-2">💼</span>
                        <span>{staff.experience || 'Not specified'}</span>
                      </p>
