  ...
  const [pdfFiles, setPdfFiles] = useState([
    {
      ...
      file: new File([new Blob(['Dummy PDF content 1'])], 'cs_sem3_syllabus.pdf', { type: 'application/pdf' }),
      size: '2.45 MB',
      uploadDate: new Date('2024-01-15').toLocaleDateString(),
    },
    {
      id: '2',
      name: 'Electrical Engineering Semester 5',
      file: new File([new Blob(['Dummy PDF content 2'])], 'ee_sem5_syllabus.pdf', { type: 'application/pdf' }),
      size: '1.78 MB',
    ...
    },
    {
      ...
      file: new File([new Blob(['Dummy PDF content 3'])], 'math_sem1_syllabus.pdf', { type: 'application/pdf' }),
      size: '3.21 MB',
    ...
    },
    {
      ...
      file: new File([new Blob(['Dummy PDF content 4'])], 'physics_lab_manual.pdf', { type: 'application/pdf' }),
      size: '0.89 MB',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="h-full flex flex-col">
            {/* Panel Header */}
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h2 className="text-xl font-semibold text-gray-800">Edit Syllabus</h2>
              <button
                onClick={cancelEdit}
                className="text-gray-400 hover:text-gray-600 transition-colors p-1"
              >
