...
const AcademicCalendar = () => {
  ...
  const [pdfFiles, setPdfFiles] = useState([
    {
      id: "1",
      name: "Fall 2023 Academic Calendar",
      file: new File(
        [new Blob(["Dummy PDF content 1"])],
        "fall_2023_calendar.pdf",
        { type: "application/pdf" },
      ),
      size: "2.45 MB",
      uploadDate: new Date("2023-08-15").toLocaleDateString(),
    },
    {
      id: "2",
      name: "Spring 2024 Schedule",
      file: new File(
        [new Blob(["Dummy PDF content 2"])],
        "spring_2024_schedule.pdf",
        { type: "application/pdf" },
      ),
      size: "1.78 MB",
      uploadDate: new Date("2024-01-10").toLocaleDateString(),
    },
    {
      id: "3",
      name: "Summer 2024 Term",
      file: new File(
        [new Blob(["Dummy PDF content 3"])],
        "summer_2024_term.pdf",
        { type: "application/pdf" },
      ),
      size: "3.21 MB",
      uploadDate: new Date("2024-05-20").toLocaleDateString(),
    },
    {
      id: "4",
      name: "Academic Year 2024-2025",
      file: new File(
        [new Blob(["Dummy PDF content 4"])],
        "academic_year_2024_2025.pdf",
        { type: "application/pdf" },
      ),
      size: "0.89 MB",
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6 relative overflow-x-hidden">
      <div className="max-w-6xl mx-auto">
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  placeholder="e.g., Fall 2023 Academic Calendar"
              ...
              <div
                ...
                onClick={
                  selectedFile ? undefined : () => fileInputRef.current?.click()
                }
              >
                <div className="flex flex-col items-center justify-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      {selectedFile
                        ? "Remove current file to select another"
        ...
        {/* Main Content Area - Only Files List */}
        <div className="">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <button
                            onClick={() =>
                              showDeleteConfirmation(pdf.id, pdf.name)
                            }
